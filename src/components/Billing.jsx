  ...
  return (
    <section id="product" className={layout.sectionReverse}>
      <div className={layout.sectionImgReverse}>
        ...
        />
        <div className="white__gradient absolute -left-1/2 top-0 z-[3] h-[50%] w-[50%] rounded-full"></div>
        <div className="pink__gradient absolute -left-1/2 bottom-0 z-[0] h-[50%] w-[50%] rounded-full"></div>
      </div>
      <div className={layout.sectionInfo}>
        ...
        <p className={`${styles.paragraph} mt-5 max-w-[470px]`}>
          ...
          sapiente sit corporis ad. Rem, ratione qui! Delectus a itaque
          corrupti.
        </p>
